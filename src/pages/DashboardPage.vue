...
.status-group-item:focus-visible {
  outline: 2px solid #176bff;
  outline-offset: 2px;
}

.status-group-item__icon,
.task-icon,
.connection-icon {
  display: inline-flex;
  align-items: center;
...
.status-group-item__copy {
  display: block;
  min-width: 0;
}

.status-group-item__copy strong {
  display: block;
  overflow: hidden;
  color: #20345f;
  font-size: 12px;
...
.status-popover__head strong {
  color: #152b58;
  font-size: 13px;
}

.status-popover__head span {
  color: #70809f;
  font-size: 11px;
}
...
.status-popover__list > div:last-child {
  border-bottom: 0;
}
...
:global(.dashboard-status-popover.el-popper) {
  border-color: #dfe7f3;
  border-radius: 8px;
