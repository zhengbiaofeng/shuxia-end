...
- Dashboard system status no longer uses a fixed-height clipping container. Service states, metrics and runtime details wrap real backend values and keep all content visible across wide desktop, `842x944` and `390x844` layouts without page-level horizontal overflow.
